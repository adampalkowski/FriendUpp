        ...
        composable(
            ...
            if (openEditEmailDialog) {
                ChangeEmailDialog(
                    ...
                    icon = com.palkowski.friendupp.R.drawable.ic_email,
            ...
            if (openDarkModeDialog) {
                FriendUppDialog(
                    ...
                    icon = com.palkowski.friendupp.R.drawable.ic_darkmode,
            ...
            if (openLogOutDialog) {
                FriendUppDialog(
                    ...
                    icon = com.palkowski.friendupp.R.drawable.ic_logout,
            ...
            if (openDeleteAccountDialog) {
                ...
                FriendUppDialog(
                    ...
                    icon = com.palkowski.friendupp.R.drawable.ic_delete,
