package com.example.friendupp.ui.theme
...
private val LightColorPalette = SocialColors(
    ...
    gradient2_1 = listOf(Gray1, LightBlue1),
...
private val DarkColorPalette = SocialColors(
    ...
    gradient2_1 = listOf(DarkBlue, Black),
...
class SocialColors(
    ...
    fun copy(): SocialColors = SocialColors(
...
fun ProvideSocialColors(
    ...
    CompositionLocalProvider(LocalSocialColors provides colorPalette, content = content)
}

object SocialTheme {
    val colors: SocialColors
        @Composable
        get() = LocalSocialColors.current
}
private val LocalSocialColors = staticCompositionLocalOf<SocialColors> {
    error("No PALLETEE provided")
}
